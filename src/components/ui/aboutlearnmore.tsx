...
const AboutMe = () => {
  return (
    <section className="pb-16 pt-8 sm:pt-16 px-4 md:px-6 border-b">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <p
            className={`text-md sm:text-lg text-muted-foreground mb-4 font-light ${poppins.className}`}
          >
          ...
          <p
            className={`text-md sm:text-lg text-muted-foreground font-light mb-6 ${poppins.className}`}
          >
