  ...
  return (
    ...
    <section className="w-full py-16 px-4 md:px-6">
          ...
          {projects.slice(0, 3).map((project, index) => (
            ...
            >
              ...
              <CardContent className="space-y-2">
                ...
                <p className={`text-md text-muted-foreground ${montserrat.className}`}>{project.role}</p>
      ...
      <div className='flex justify-center'>
        <Link href="/portfolio">
        <Button variant={'outline'} className={`px-6 py-6 text-sm sm:text-md rounded-full dark:hover:bg-blue-400 transition-colors hover:bg-blue-400 hover:text-white  ${montserrat.className}`}>View all work</Button>
      </Link>
      </div>
